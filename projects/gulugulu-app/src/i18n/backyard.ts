...
export const BACKYARD_LABEL_LOCALES = {
  "zh-Hant": {
    ...
    hatchery: { collectPill: "✨ 收取！" }, nearPet: { fuse: "融合", follow: "跟隨", release: "放生" },
  },
  ja: {
    ...
    hatchery: { collectPill: "✨ 受け取る！" }, nearPet: { fuse: "合成", follow: "ついていく", release: "放す" },
  },
  ko: {
    ...
    hatchery: { collectPill: "✨ 받기!" }, nearPet: { fuse: "융합", follow: "따라가기", release: "놓아주기" },
  },
  fr: {
    ...
    hatchery: { collectPill: "✨ Récupérer !" }, nearPet: { fuse: "Fusionner", follow: "Suivre", release: "Relâcher" },
  },
  de: {
    ...
    hatchery: { collectPill: "✨ Einsammeln!" }, nearPet: { fuse: "Verschmelzen", follow: "Folgen", release: "Freilassen" },
  },
  "es-ES": {
    ...
    hatchery: { collectPill: "✨ Recoger!" }, nearPet: { fuse: "Fusionar", follow: "Seguir", release: "Liberar" },
  },
  "es-419": {
  ...
  "pt-BR": {
    ...
    hatchery: { collectPill: "✨ Coletar!" }, nearPet: { fuse: "Fundir", follow: "Seguir", release: "Soltar" },
  },
  "pt-PT": {
    ...
    hatchery: { collectPill: "✨ Recolher!" }, nearPet: { fuse: "Fundir", follow: "Seguir", release: "Libertar" },
  },
  ru: {
    ...
    hatchery: { collectPill: "✨ Забрать!" }, nearPet: { fuse: "Слияние", follow: "Следовать", release: "Отпустить" },
  },
  it: {
    ...
    hatchery: { collectPill: "✨ Raccogli!" }, nearPet: { fuse: "Fondi", follow: "Segui", release: "Libera" },
  },
  pl: {
    ...
    hatchery: { collectPill: "✨ Odbierz!" }, nearPet: { fuse: "Połącz", follow: "Podążaj", release: "Zwolnij" },
  },
  tr: {
    ...
    hatchery: { collectPill: "✨ Topla!" }, nearPet: { fuse: "Birleştir", follow: "Takip et", release: "Serbest bırak" },
  },
  uk: {
    ...
    hatchery: { collectPill: "✨ Забрати!" }, nearPet: { fuse: "Злити", follow: "Слідувати", release: "Відпустити" },
  },
  ar: {
    ...
    hatchery: { collectPill: "✨ جمع!" }, nearPet: { fuse: "دمج", follow: "اتبع", release: "إطلاق" },
  },
  th: {
    ...
    hatchery: { collectPill: "✨ เก็บ!" }, nearPet: { fuse: "ผสม", follow: "ติดตาม", release: "ปล่อย" },
  },
  vi: {
    ...
    hatchery: { collectPill: "✨ Thu thập!" }, nearPet: { fuse: "Dung hợp", follow: "Theo sau", release: "Thả" },
  },
  id: {
    ...
    hatchery: { collectPill: "✨ Ambil!" }, nearPet: { fuse: "Fusi", follow: "Ikuti", release: "Lepaskan" },
  },
  nl: {
    ...
    hatchery: { collectPill: "✨ Ophalen!" }, nearPet: { fuse: "Fuseren", follow: "Volgen", release: "Vrijlaten" },
  },
