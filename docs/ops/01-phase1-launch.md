...
> 窗口：2026-07-21 → 发售后 4 周（≈09-15）。目标：以 **USD $1.99** 于 2026-08-18 发售，一次性拉满势能，把购买转化为活跃与市场流动性。
...
| T-7 | **达人外联第一波 30 封**（SOP 见 `ops/bd/`；已验证且有兴趣者通过 Steam 预发布邀请试玩，附 press kit + 发售日期 + b-roll 包） | — |
...
| +10 分钟 | 验证商店页 USD $1.99 / 成就 / 工坊 / 市场可见 → Steam 发售公告（双语）→ X 发售 thread → Discord @everyone | 🤖（公告与帖子当场批） |
