...
用 `mobistudiodev@gmail.com` 的 Google 账号在 youtube.com 创建**频道**（Create a channel），再到 studio.youtube.com → Customization 完善。

| 字段 | 填写内容 |
|---|---|
| 频道名 | `Mobi Studio` |
| Handle | `@mobistudiohd`（与 X 统一；被占退 `@mobistudiodev`） |
| 头像 | `avatar-mobi-800.png`（工作室 Logo） |
| 横幅 | `banner-2560x1440.png`（Gulugulu 主打横幅；关键内容已收进设备安全区，电视/手机/网页裁切都安全） |
...
1. GitHub — `https://github.com/SpecterMyth/Gulugulu`
2. Steam — Coming Soon 上线后补 `https://store.steampowered.com/app/4956830/`
3. X — 注册好后补
4. Discord — 建服后补邀请链接

## 注意

- 频道先空着没关系；A3 预告片定稿后我出 30s 剪辑作首个上传（走队列）。
- 上传默认设置里把「面向儿童」设为**否**（游戏内容非儿童定向，勿误勾）。
